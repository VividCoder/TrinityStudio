...
namespace TrinityEngine.Util.Texture
{
    public class TexTree
    {
        ...
        public TrinityEngine.Texture.TextureRaw Raw;
        ...
        {
            RC = new Rect(0, 0, w, h);
            Raw = new TrinityEngine.Texture.TextureRaw(w, h, false);
            //Root = ne
            //w TreeLeaf (new Rect(0,0,w,h));
        }

        public TrinityEngine.Texture.Texture2D GetMap()
        {
            return new TrinityEngine.Texture.Texture2D(Raw);
        }
