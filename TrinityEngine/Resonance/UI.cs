...
namespace TrinityEngine.Resonance
{
    public class UI
    {
       ...
       // public static TrinityEngine.Font2Font2D Font = null;
        ...
        public TrinityEngine.Texture.Texture2D CursorImg;
        ...
        public UI()
        {
            ...
            Root = new UIForm().Set(0, 0, 800,600);
        ...
        public void InitUI()
        {
           ...
           // Font = new Font2D("data/font/times.ttf.vf");
            CursorImg = new Texture.Texture2D("data/ui/cursor1.png", TrinityEngine.Texture.LoadMethod.Single, true);
        }
        float MZD, MZ;
        public void Update()
        {
        ...
        public void UpdatePadInput()
        {
            ...
            {
                /*
                if (TrinityEngine.Input.XIn.bA() == false)
                {
            ...
            if (TrinityEngine.Input.XIn.DDown())
            {
                lastPad = tick;
            ...
            if (TrinityEngine.Input.XIn.DUp())
            {
                lastPad = tick;
        ...
        public void Render()
        {
            ...
            TrinityEngine.Draw.IntelliDraw.Draw_Z = 0.001f;
            TrinityEngine.Draw.IntelliDraw.BeginDraw(true);
            foreach (var form in list)
            {
        ...
        public void Render2()
        {
            ...
            if (Top != null)
            {
                ...
                foreach (UIForm form in RenderList)
                {
                   ...
                   // GL.Scissor(form.ViewX, TrinityEngine.App.AppInfo.H - (form.ViewY + form.ViewH), form.ViewW, form.ViewH);
                    //  // GL.Scissor(form.ViewX, form.ViewY, form.ViewW, form.ViewH);
                    // GL.Scissor(0, 0, App.AppInfo.W, App.AppInfo.H);
                    //  GL.Scissor(form.ViewX, form.ViewY, form.ViewW, form.ViewH);
                    GL.Enable(EnableCap.ScissorTest);
             ...
             //   Texture.Texture2D ntex = new Texture.Texture2D(TrinityEngine.App.AppInfo.W, TrinityEngine.App.AppInfo.H);
            ...
            TrinityEngine.Draw.IntelliDraw.DrawImg(MX, MY, 24, 24, CursorImg, new Vector4(1, 1, 1, 1));
           ...
           // TrinityEngine.Draw.Pen2D.SetProj(0, 0, TrinityEngine.App.AppInfo.W, TrinityEngine.App.AppInfo.H);
           // TrinityEngine.Draw.Pen2D.BlendMod = TrinityEngine.Draw.PenBlend.Alpha;
            TrinityEngine.Draw.Pen2D.Rect(MX, MY, 24, 24, CursorImg, new OpenTK.Vector4(1, 1, 1, 1));

            GL.DisableVertexAttribArray(0);
            GL.DisableVertexAttribArray(1);
            GL.DisableVertexAttribArray(2);
            TrinityEngine.Draw.Pen2D.Unbindv();
