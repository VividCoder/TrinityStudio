...
namespace TrinityEngine.Resonance.Forms
{
    public class ButtonForm : UIForm
    {
        ...
        public static TrinityEngine.Audio.VSoundSource BleepSrc;
        public static TrinityEngine.Audio.VSoundSource BingSrc;
        ...
        public ButtonForm()
        {
            ...
            if (BleepSrc == null)
            {
                ...
                BleepSrc = TrinityEngine.Audio.Songs.LoadSound("Corona/Sound/UI/beep1.wav");
                BingSrc = TrinityEngine.Audio.Songs.LoadSound("Corona/Sound/UI/click1.wav");
            }
            if (Font == null)
            {
            ...
            void MouseEnterFunc()
            {
                ...
                TrinityEngine.Audio.Songs.PlaySource(BingSrc);
                Over = true;
            }
            ...
            {
                Col = PressCol;
                TrinityEngine.Audio.Songs.PlaySource(BleepSrc);
                Pressed = true;
            }
